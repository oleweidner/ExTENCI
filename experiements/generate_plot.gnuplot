...
set output '| ps2pdf - results-04.pdf'
...
set title "Replication times for different data volumes \n from central iRODS server to osgGridFtpGroup sites (# 4)" 
set yrange [ 0.00000 : 3000 ] noreverse nowriteback
set ylabel "Time (s)"
set xlabel "Data volume"
plot for [COL=2:10] 'results/results-04.dat' using COL:xticlabels(1) title columnheader
